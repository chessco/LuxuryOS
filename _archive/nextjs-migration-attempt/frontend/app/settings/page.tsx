  ...
  return (
    <div className="flex-1 flex flex-col items-center max-w-5xl mx-auto w-full">
      <div className="w-full flex flex-col gap-10">
        <div>
          <h1 className="text-white text-4xl font-black tracking-tight">Configuración</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sections.map(section => (
            <button key={section.title} className="group flex items-start gap-6 p-8 rounded-3xl bg-zinc-900/30 border border-zinc-900 hover:border-zinc-700 transition-all text-left backdrop-blur-sm">
              <div className="size-14 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center shrink-0 group-hover:bg-white group-hover:text-black transition-all shadow-xl">
        ...
        <div className="mt-6 p-8 rounded-3xl bg-zinc-950/50 border border-zinc-900/50 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-white text-xs font-bold font-black uppercase tracking-widest">Sistema Actualizado</p>
              <p className="text-zinc-600 text-[10px] uppercase tracking-widest">Luxury OS v1.2.4 (Jewelry Atelier Edition)</p>
            </div>
          </div>
