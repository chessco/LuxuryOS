...
const AIAssistantPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-160px)] max-w-5xl mx-auto w-full">
            <div className="flex flex-col h-full bg-zinc-900/20 border border-zinc-900 rounded-3xl overflow-hidden backdrop-blur-sm shadow-2xl transition-all duration-500">
                {/* Chat Header */}
                <div className="px-8 py-6 border-b border-zinc-900 bg-zinc-900/40 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-white text-sm font-black uppercase tracking-widest font-display">Intelligence Assistant</h2>
