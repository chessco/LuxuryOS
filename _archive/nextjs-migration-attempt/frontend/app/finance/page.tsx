...
const transactions = [
  { id: 'TR-9023', description: 'Venta - Anillo Diamante', category: 'Ingreso', amount: '+$12,500', status: 'Completado', date: 'Hoy, 14:30' },
  { id: 'TR-9024', description: 'Compra de Materiales', category: 'Gasto', amount: '-$5,200', status: 'Pendiente', date: 'Hoy, 12:15' },
  { id: 'TR-9025', description: 'Nómina Taller', category: 'Gasto', amount: '-$8,400', status: 'Completado', date: 'Ayer' },
];
      ...
      <div className="w-full flex flex-col gap-8">
        ...
        <div className="flex flex-col lg:flex-row flex-wrap justify-between gap-6 items-start lg:items-end">
          <div className="flex flex-col gap-3 max-w-2xl">
            <h1 className="text-white text-4xl font-black tracking-tight">Finanzas</h1>
            <p className="text-zinc-500 text-sm font-medium">Control de ingresos, gastos y salud financiera del atelier.</p>
          </div>
          <div className="flex gap-3">
            <button className="flex items-center justify-center gap-2 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition-all h-12 px-6 text-zinc-400 hover:text-white text-xs font-black uppercase tracking-widest active:scale-95">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 rounded-3xl bg-zinc-900/40 border border-zinc-900 backdrop-blur-sm shadow-sm flex flex-col gap-4">
            ...
            <p className="text-white text-4xl font-black tracking-tighter">$1,452,300</p>
          ...
          <div className="p-8 rounded-3xl bg-zinc-900/40 border border-zinc-900 backdrop-blur-sm shadow-sm flex flex-col gap-4">
            ...
            <p className="text-white text-4xl font-black tracking-tighter">$245,000</p>
          ...
          <div className="p-8 rounded-3xl bg-zinc-900/40 border border-zinc-900 backdrop-blur-sm shadow-sm flex flex-col gap-4">
            ...
            <p className="text-white text-4xl font-black tracking-tighter">$152,000</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 p-8 rounded-3xl bg-zinc-900/40 border border-zinc-900 backdrop-blur-sm flex flex-col gap-8">
            <div className="flex items-center justify-between">
              <h3 className="text-white text-lg font-black tracking-tight uppercase">Historial Financiero</h3>
          ...
          <div className="p-8 rounded-3xl bg-zinc-900/40 border border-zinc-900 backdrop-blur-sm flex flex-col gap-6">
            <h3 className="text-white text-lg font-black tracking-tight uppercase">Transacciones Recientes</h3>
