    ...
    return (
        <div className="flex-1 flex flex-col items-center max-w-[1400px] mx-auto w-full">
            <div className="w-full flex flex-col gap-8">
                {/* Breadcrumbs */}
                <div className="flex flex-wrap gap-2 items-center text-zinc-500 text-[10px] font-black uppercase tracking-widest">
                ...
                <div className="flex flex-col lg:flex-row flex-wrap justify-between gap-6 items-start lg:items-end">
                    <div className="flex flex-col gap-3 max-w-2xl">
                        <h1 className="text-white text-4xl font-black tracking-tight font-display">Gestión de Clientes</h1>
