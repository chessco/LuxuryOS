  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-xl px-8">
      ...
      <div className="flex items-center gap-6 ml-auto">
        ...
        <button className="hidden md:flex items-center gap-2 rounded-xl bg-white hover:bg-zinc-200 px-5 py-2.5 text-xs font-bold text-black uppercase tracking-widest transition-all active:scale-95">
